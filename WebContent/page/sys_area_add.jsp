...
<!-- #header -->
  ...
  <div id="content" class="xgrid">
	<form action="${pageContext.request.contextPath}/SyArea/addArea" method="post" onsubmit="return checkFrom()">
	  <div class="x12">
 		<h2>添加/修改抄表辖区</h2>
 		<div class="form label-inline uniform">
		  <div class="field">
			<label for="id">抄表辖区ID</label> <input id="id" name="fname"
		  ...
		  <div class="field">
			...
			<textarea rows="7" cols="50" id="remark" name="remark"></textarea>
		  </div>
		  <div class="buttonrow">
