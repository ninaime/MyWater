  ...
  <div id="content" class="xgrid">
	<div class="x12">
	  ...
	  <div class="form label-inline uniform">
		...
		action="${pageContext.request.contextPath}/SyDept/addDept?id=${sy.id}" >
		  <div class="field">
			<label for="id">部门ID</label> <input id="id" name="id" size="50"
			type="text" class="medium" disabled="disabled" value="自动生成" />
		  </div>
		  <div class="field">
		  ...
		  <div class="field">
			...
			<textarea rows="7" cols="50" id="description" name="remark"></textarea>
		  </div>
		  <div class="buttonrow">
